...
<div id="logo-parent" class="grid w-full grid-rows-2 gap-5 md:grid-cols-2 md:grid-rows-1">
	<div id="image" class="flex items-center justify-center">
		<img src="media/frog.svg" alt="A stylized frog" class="h-11/12 w-9/12 md:w-11/12" />
	</div>
	<div id="text" class="">
		<div id="name">
			<h1
