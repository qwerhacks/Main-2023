...
>
	{#each array as sq, i}
		<div
			class="aspect-square border-t-4 border-l-4 border-solid border-[#A84FB3] outer opacity-20 square-{i}"
		/>
	{/each}
</div>
...
<style lang="scss">
	.gradient {
		background-image: linear-gradient(180deg, #180230bb 0%, #a84fb3de 100%),
			radial-gradient(#a84fb3 0%, #180230 80%);
