...
<div class="w-full h-full bg-[#FFF7F1]">
  ...
  <img src="media/left_side.svg" alt="" class="absolute top-0 bottom-0 left-0 h-full"/>
  <img src="media/right_side.svg" alt="" class="absolute top-0 bottom-0 right-0 hidden h-full md:block"/>
</div>