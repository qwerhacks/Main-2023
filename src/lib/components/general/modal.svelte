<script lang="ts" context="module">
  ...
  export function openModal(component: ComponentType) {
    modal_open.set(true);
...
<div
  class="flex items-center justify-center fixed inset-0 z-50 overflow-y-auto bg-white/1 backdrop-blur-[10px]"
